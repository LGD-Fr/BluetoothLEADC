...
#define SWAKE_TRIS               TRISAbits.TRISA4
#define SWAKE_LAT                LATAbits.LATA4
#define SWAKE_PORT               PORTAbits.RA4
#define SWAKE_WPU                WPUAbits.WPUA4
#define SWAKE_ANS                ANSELAbits.ANSA4
#define SWAKE_SetHigh()            do { LATAbits.LATA4 = 1; } while(0)
#define SWAKE_SetLow()             do { LATAbits.LATA4 = 0; } while(0)
#define SWAKE_Toggle()             do { LATAbits.LATA4 = ~LATAbits.LATA4; } while(0)
#define SWAKE_GetValue()           PORTAbits.RA4
#define SWAKE_SetDigitalInput()    do { TRISAbits.TRISA4 = 1; } while(0)
#define SWAKE_SetDigitalOutput()   do { TRISAbits.TRISA4 = 0; } while(0)
#define SWAKE_SetPullup()      do { WPUAbits.WPUA4 = 1; } while(0)
#define SWAKE_ResetPullup()    do { WPUAbits.WPUA4 = 0; } while(0)
#define SWAKE_SetAnalogMode()  do { ANSELAbits.ANSA4 = 1; } while(0)
#define SWAKE_SetDigitalMode() do { ANSELAbits.ANSA4 = 0; } while(0)
